...
import controller.ControllerCreateProduct;
...
public class CreateProduct extends javax.swing.JFrame {
    ...
    private ControllerCreateProduct controllerCreateProduct;
    ...
    public CreateProduct() {
        initComponents();
        controllerCreateProduct = new ControllerCreateProduct();
        changes = false;
    }
    ...
    private void initComponents() {
        ...
        windowName.setText("Crear nuevo producto");
        windowBar.add(windowName, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 200, 30));
        ...
        btnAddProduct.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addGap(50, 50, 50)
                .addComponent(formPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        try {
            ...
            try {
                ...
                try {
                    throw new Exception("No se pueden ingresar letras en este campo");
                } catch (Exception ex) {
            ...
            controllerCreateProduct.createProduct(product);
            try {
                    Home home = new Home();
